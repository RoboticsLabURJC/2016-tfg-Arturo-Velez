...
\hspace{1 cm} Esta parte es la parte principal con la que tiene que lidiar el componente. Para obtener la entrada, el componente se conecta al interfaz de comunicaciones ICE mediante la función \texttt{self.camera.getImage()}, esta función se encarga de obtener las imágenes que el interfaz ofrece y este a su vez las puede obtener de diferentes fuentes, en este caso, la obtiene de la cámara del drone simulado de Gazebo.\\
